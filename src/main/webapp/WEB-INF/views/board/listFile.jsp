...
<%@ taglib prefix="ui" uri="http://foo.com/tag" %>
...
<a href="https://pqina.nl/filepond/docs/" target="_blank"><img alt="duke" src="<c:url value='/resources/images/filepond-logo.jpg'/>" style="width: 200px; height: 88px;"/></a>
<div style="width: 50%;">
<form name="frm" method="post">
    ...
    <div align="right" style="padding-bottom: 5px">
            ...
            <input type="hidden" name="boardId" value="BOARD_0002" />
...
<table width="100%" cellpadding="5" class="table-line">
    ...
    <div align="center" class="pagination">
        <ui:pagination paginationInfo="${pagingInfo}" type="image" jsFunction="fn_page" />
	</div>
...
<script type="text/javascript">
	...
	function fn_posting(){
		document.frm.action = "<c:url value='/board/addPostingFile.do'/>";
		document.frm.submit();
	}
